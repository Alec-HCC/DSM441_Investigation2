...
// Definición de la clase PlanetAdapter que extiende RecyclerView.Adapter y toma una lista de imágenes de planetas como parámetro
class PlanetAdapter(private val images: List<String>?) :
